      ...
      sections: {
        ...
        levelSystem: {
          ...
          levels: [
            ...
            { level: "L10 · Champion 👑",           pts: "10,00,000",   discount: "20% OFF",  perks: "⚡ Daily Limit Bonus up to +200%, Champion Frame" },
      ...
      sections: {
        ...
        levelSystem: {
          ...
          levels: [
            ...
            { level: "L10 · Champion 👑",           pts: "10,00,000",   discount: "20% OFF",  perks: "⚡ Daily Limit Bonus max +200%, Champion Frame" },
